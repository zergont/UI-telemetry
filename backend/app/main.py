...
from app.routers import admin_proxy, analytics_proxy, chart_settings, dgu_card_settings, equipment, events, history, notifications, objects, registers, share, system, tiles, ws
