...
/** Токи фаз вертикальным эквалайзером: высота столбика — доля от номинала, цвет — нагрузка */
      ...
      {LABELS.map((label, i) => {
        ...
        return (
          <div key={label} className="flex min-h-12 flex-1 flex-col text-center">
            ...
            <span className="mt-1 font-mono text-[11px] leading-none tabular-nums text-foreground/90">
